import '../css/OrganizerDraftCard.css';
            ...
            <div className='card-body'>
              <div className="edit-delete">
                <i className="edit-icon" onClick={handleRedirect}>
                  <button className="btn btn-outline-success btn-sm" style={{width:"4vw"}}>Edit
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ff8000" className="bi bi-pencil-square" viewBox="0 0 16 16" style={{marginLeft:"10%"}} >
                ...
                <i className="trash-icon" onClick={handleDeleteDraft}>
                  <button className="btn btn-outline-success btn-sm " style={{marginLeft:"28%",width:"5vw"}}>Delete
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ff8000" className="bi bi-trash3" viewBox="0 0 16 16" style={{marginLeft:"10%"}} >
